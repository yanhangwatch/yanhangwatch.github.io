...
鹽行國中重劃區觀測站，是一個聚焦於**台南市永康區鹽行國中重劃區**的獨立觀測平台，整理公開資料與實地紀錄，記錄城市發展、產業設施與生活空間之間的實際樣貌。
...
- **🗣️ 鹽論觀點**  
  討論資訊透明度、制度設計與判斷風險，補上城市敘事中較少被完整說明的那一頁。
...
本站同步於多個社群平台更新，內容以觀測紀錄為主，不進行商業合作或代言：
...
本站內容整理自公開資料與實地觀察，僅供資訊紀錄與研究參考，不構成投資、購屋或任何形式之建議。實際情況請以政府機關公告與正式文件為準。
